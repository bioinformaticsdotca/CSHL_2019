...
Post workshop content for data sets, docker containers, AWS image, tools and install instructions can be foudn [here](https://bioinformaticsdotca.github.io/CSHL_2019_Post-Workshop)  
